    ...
    public class GetAccessTokenUsingAdal
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                AuthenticationContext authenticationContext = new(authority, false, null);
                ClientAssertionCertificate clientAssertion = new(clientId, certificate);
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            X509Store x509Store = new (storeName, storeLocation);
